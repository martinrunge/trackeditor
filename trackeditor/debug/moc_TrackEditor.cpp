...
**
** Created: Sat Sep 6 12:45:02 2008
...
static const char qt_meta_stringdata_LogReader[] = {
    ...
    "disconnectDevice()\0readLog()\0"
    "startRecording()\0stopRecording()\0"
    "loadTrack()\0saveTrack()\0saveTrackAs()\0"
    "index\0treeViewClicked(QModelIndex)\0,\0"
...
int LogReader::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: startRecording(); break;
        case 8: stopRecording(); break;
        case 9: loadTrack(); break;
        case 10: saveTrack(); break;
        case 11: saveTrackAs(); break;
        case 12: treeViewClicked((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        case 13: selectionChanged((*reinterpret_cast< QItemSelection(*)>(_a[1])),(*reinterpret_cast< QItemSelection(*)>(_a[2]))); break;
        case 14: addData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        }
        _id -= 15;
    }
    return _id;
